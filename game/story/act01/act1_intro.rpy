label act_1_start:
    ...
    call mage_lineage_exp from _call_mage_lineage_exp
    ...
    call necromancy_exp from _call_necromancy_exp

    PLAYER "I knew it!  Your clan is one of the only necromancers allowed to practice its arts for special use cases."
    ...
    call amp_exp from _call_amp_exp
    ...
    call transit_exp from _call_transit_exp
    ...
    call enfeeble_exp from _call_enfeeble_exp
